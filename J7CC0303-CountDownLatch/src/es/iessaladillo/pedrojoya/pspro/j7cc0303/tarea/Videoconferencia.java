...
public class Videoconferencia implements Runnable {
	...
	public Videoconferencia(int participantes) {
		...
		// Creo el controlador con una cuenta atrás igual al número de
		// participantes.
	...
	public void run() {
		...
		System.out.printf(
				"%s -> Estableciendo conexión con los %d participantes\n",
		...
		try {
			...
			System.out
					.printf("%s -> Todos los participantes conectados. Comenzando...\n",
