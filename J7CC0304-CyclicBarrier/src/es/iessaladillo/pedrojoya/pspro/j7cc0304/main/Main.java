...
public class Main {
	...
	public static void main(String[] args) {
		...
		// que recorrerá el array de resultados parciales, sumando los
		// resultados.
		Sumador sumador = new Sumador(resultado);

		// Creo el objeto CyclicBarrier object. Cuando los cinco hilos
		// participantes
		...
		for (int i = 0; i < BUSCADORES; i++) {
			...
			Thread hiloBuscador = new Thread(new Buscador(primeraFila,
					ultimaFila, matriz, resultado, VALOR_A_BUSCAR, barrera),
					"Buscador " + i);
			hiloBuscador.start();
		}
	}
